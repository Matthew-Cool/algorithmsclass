...
const std::string testcases = "../HW1-testcase/testcases.txt";
const std::string map_info_testcases = "../HW1-testcase/map_info.txt";
...
//For Grading purpose. Don't modify this function.
...
int main() {
    ...
    if (testQueue()) {
        std::cout << "Your queue implementation is correct\n";
    } else {
        std::cout << "Your queue implementation is incorrect\n";
        return -1;
    }
